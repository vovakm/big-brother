...
if (!function_exists('printMessage'))
{
	...
	function printMessage($event)
	{
		$messages = array(
			...
			'e2' => 'Действие указано с ошибкой',
			'e3' => 'Не указано действие, которое следует выполнить',
			'e4' => '',
			'e5' => '',
			'e6' => '',
			'e7' => '',

			/* ошибки при проверки формы редактирования пользователя */
			'e_pass_num' => 'Номер пропуска указан неверно',
			'e' => '',
		);
