...
(function($) {
	...
	$.fn.jclock.formatTime = function(time, el) {
		...
		for (i = 0; i <= 7; i++)
			if ((timeNow.substring(0, 2) == begin[0][i]) && (timeNow.substring(3, 5) == begin[1][i]))
				timeNow = '<span class="greenText" title="Начало '+(i+1)+' пары">'+timeNow+'</span>';
		else if((timeNow.substring(0, 2) == end[0][i]) && (timeNow.substring(3, 5) == end[1][i]))
		timeNow = '<span class="redText" title="Конец '+(i+1)+' пары">'+timeNow+'</span>';
		return timeNow;
	};
	...
	var begin = [
	['07','09','11','12','14','15','17'],
	['45','15','05','35','05','45','15'],
	];
	var end = [
	['09','10','12','13','15','17','18'],
	['05','35','25','55','25','05','35'],
	];
	$.fn.jclock.defaults = {
		format: '%H:%M:%S',
		utcOffset: 0,
